                ...
                <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
                    <div className="mb-8">
                        ...
                        <p className={`text-base sm:text-lg md:text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed transform transition-all duration-1000 delay-500 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0'}`}>
                            Your all-in-one swag platform.
                            <span className="relative mx-2">
                                <span className="text-[#bf272f] font-semibold">Shop, store, and ship</span>
                                <div className="absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-[#bf272f] to-transparent"></div>
                            </span>
                            high-quality swag across the globe – effortlessly.
                        </p>
                    </div>
                    ...
                    <div className={`flex flex-col sm:flex-row items-center justify-center gap-4 mb-16 transform transition-all duration-1000 delay-700 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0'}`}>
                        ...
                        <button className="group relative flex items-center space-x-3 px-8 py-4 border border-white/20 text-white font-medium rounded-full backdrop-blur-sm hover:bg-white/5 hover:border-[#bf272f]/50 transition-all duration-300">
                            <div className="absolute inset-0 bg-gradient-to-r from-[#bf272f]/0 via-[#bf272f]/5 to-[#bf272f]/0 transform -skew-x-12 -translate-x-full group-hover:translate-x-full transition-transform duration-1000"></div>
                            <div className="relative w-10 h-10 bg-white/10 rounded-full flex items-center justify-center group-hover:bg-[#bf272f]/20 transition-all duration-300">
