            ...
            >
                ...
                <div className="flex items-center justify-between px-6 lg:px-20 py-4 max-w-7xl mx-auto">
                    ...
                    <div className="flex items-center">
                        ...
                        {/* <button className="hidden lg:block relative overflow-hidden bg-red-600 text-white px-6 py-3 rounded-full font-semibold transition-all duration-300 hover:bg-red-700 hover:shadow-lg hover:shadow-red-200 group">
